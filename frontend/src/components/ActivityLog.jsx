...
export default function ActivityLog({ logs = [] }) {
    ...
    return (
        <motion.div
            ...
            className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.05] rounded-3xl overflow-hidden shadow-2xl"
        >
                                ...
                                logs.map((entry, i) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            {/* Timestamp */}
                                            {ts && (
                                                <span className="text-slate-500 shrink-0 w-[4.5rem] text-right tabular-nums">
                                                    {ts}
                                                </span>
                                            )}
