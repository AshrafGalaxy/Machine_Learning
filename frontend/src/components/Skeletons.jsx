...
export function SkeletonText({ width = 'w-full', className = '' }) {
    return (
        <div className={`animate-pulse rounded-md bg-slate-800/50 h-4 ${width} ${className}`} />
    );
}
        ...
        >
            <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.05] rounded-3xl p-6 sm:p-8 shadow-2xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    {[...Array(6)].map((_, i) => (
                        <div key={i} className="bg-slate-800/30 rounded-xl p-4 border border-white/[0.05]">
            ...
            <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.05] rounded-3xl p-6 sm:p-8 shadow-2xl">
                ...
                <div className="flex flex-col items-center gap-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full">
                        {[...Array(3)].map((_, i) => (
                            <div key={i} className="bg-slate-800/30 rounded-xl p-4 border border-white/[0.05] text-center">
